                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Obx((){return controller.imagesList.value.isNotEmpty ? ImagesItem(
                      favoriteUnFavoriteClick: (value){
                        ...
                        if(value=="0" && controller.favoriteController.imagesList.isNotEmpty ){
                          controller.favoriteController.imagesList.removeWhere((item) => item.id == controller.imagesList[index].id);
                        }else{
                          controller.favoriteController.imagesList.add(controller.imagesList[index]);
                        }
                      },
