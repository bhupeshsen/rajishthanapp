...
class ImagesView extends GetView<ImagesDetailsController> {
  ...
  ImagesDetailsController controller =
      Get.put(ImagesDetailsController(Get.find()));
        ...
        return controller.isLoading.value
            ...
            : Column(
                ...
                children: [
                  ...
                  Obx(() {
                    return controller
                            .detailResponse.value.photographer!.isNotEmpty
                        ? Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: controller
                                                    .detailResponse.value.url !=
                                                null
                                            ? Image.network(
                                                controller.detailResponse.value
                                                    .src!.large!,
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(
                                      left: 20, right: 25, top: 0, bottom: 0),
                                  child: Row(
                                    children: [
                                      Icon(
                  ...
                  Wrap(
                    children: [
                      InkWell(
                        onTap: () {
                          Get.to(() => ViewImagesView(), arguments: [
                            controller.detailResponse.value.src!.original
                          ]);
                        },
                        child: Container(
                      ...
                      InkWell(
                        onTap: () {
                          Get.to(() => ViewImagesView(), arguments: [
                            controller.detailResponse.value.src!.large2x
                          ]);
                        },
                        child: Container(
                          margin: EdgeInsets.all(5),
                      ...
                      InkWell(
                        onTap: () {
                          Get.to(() => ViewImagesView(), arguments: [
                            controller.detailResponse.value.src!.medium
                          ]);
                        },
                        child: Container(
                          margin: EdgeInsets.all(5),
                      ...
                      InkWell(
                        onTap: () {
                          Get.to(() => ViewImagesView(), arguments: [
                            controller.detailResponse.value.src!.small
                          ]);
                        },
                        child: Container(
                          margin: EdgeInsets.all(5),
                      ...
                      InkWell(
                        onTap: () {
                          Get.to(() => ViewImagesView(), arguments: [
                            controller.detailResponse.value.src!.portrait
                          ]);
                        },
                        child: Container(
                          margin: EdgeInsets.all(5),
                      ...
                      InkWell(
                        onTap: () {
                          Get.to(() => ViewImagesView(), arguments: [
                            controller.detailResponse.value.src!.landscape
                          ]);
                        },
                        child: Container(
                          margin: EdgeInsets.all(5),
                      ...
                      InkWell(
                        onTap: () {
                          Get.to(() => ViewImagesView(), arguments: [
                            controller.detailResponse.value.src!.tiny
                          ]);
                        },
                        child: Container(
                          margin: EdgeInsets.all(5),
